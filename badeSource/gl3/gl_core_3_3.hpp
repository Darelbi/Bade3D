...
/** BadeEngine Edit:*/
#ifndef _MSC_VER
 #define BADE_GL_LOAD_GEN_MSC_VER 0  //fix warning
#else
 #define BADE_GL_LOAD_GEN_MSC_VER _MSC_VER
#endif
		...
		#endif
		#include <windows.h>
	#elif (BADE_GL_LOAD_GEN_MSC_VER >= 800) || defined(_STDCALL_SUPPORTED) || defined(__BORLANDC__)
		#ifndef WIN32_LEAN_AND_MEAN
			#define WIN32_LEAN_AND_MEAN 1
		#endif
		#ifndef NOMINMAX
...
namespace gl
{
	namespace exts
	{
		...
		public:
			...
			{
				return m_isLoaded ? &LoadTest::big_long_name_that_really_doesnt_matter : nullptr;
			}
